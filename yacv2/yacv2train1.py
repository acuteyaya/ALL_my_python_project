...
from yacv2train0 import load_dataset, resize_image, IMAGE_SIZE
MODEL_PATH = 'E:\\window\\tiaoshi\\pycharm\\ya\\yacv2\\model\\zcl.face.model.h5'
import os
...
if __name__ == '__main__':
    dataset = Dataset('E:\\window\\tiaoshi\\pycharm\\ya\\ima')
    dataset.load()
    model = Model()
